...
Your response MUST be a valid JSON object containing exactly two keys: "relevance" and "explanation". Do not include the original question or answer keys in the JSON.

Classify the answer as one of these exact values:
